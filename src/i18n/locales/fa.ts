export default {
  ...
  'stt.busyClone':
    '⏳ همین حالا کسی در این تماس در حال ضبط کلون صدا است. من فقط یک میکروفون دارم — وقتی تمام شد دوباره تلاش کن (چند ثانیه).',
  'clone.busyStt':
    '⏳ رونویسی در این تماس فعال است و من فقط یک میکروفون دارم. اول `/transcribe stop` را اجرا کن و بعد کلون خود را ضبط کن.',
};
