export default {
  ...
  "preview.sample": "Szia, Voxem vagyok. írd be, hallgasd meg.",
  ...
  "setup.done": "**Minden kész — a Voxem indulásra kész.**",
  ...
  "setup.fixHint": "A hiányzók javításához: a szerverbeállításokban nyisd meg a Voxem szerepét (vagy a csatorna jogosultságait), és engedélyezd a ❌ jellel jelölt elemeket.",
  ...
  "stats.title": "**Voxem statisztikák**",
  ...
  "invite.noClientId": "A Voxem meghívólinkje még nincs beállítva (hiányzik a CLIENT_ID). Szólj a bot adminjának.",
  "invite.link": "Add hozzá a Voxemt a szerveredhez:\n{url}",
  "vote.noClientId": "A Voxem szavazólinkje még nincs beállítva (hiányzik a CLIENT_ID). Szólj a bot adminjának.",
  "vote.link": "Szavazz a Voxemra (ingyenes, 12 óránként), és segíts, hogy többen megtalálják:\n{url}",
  "help.title": "Voxem — írd be, hallgasd meg.",
  "help.embedTitle": "Voxem — Parancsok",
  "help.intro": "A Voxem hangosan felolvassa a szövegedet a hangcsatornákban — ingyenes neurális hangok, több tucat nyelven.",
  ...
  "welcome.footer": "Voxem — írd be, hallgasd meg.",
