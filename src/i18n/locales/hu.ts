export default {
  ...
  "preview.sample": "Szia, Vozi vagyok. írd be, hallgasd meg.",
  ...
  "setup.done": "**Minden kész — a Vozi indulásra kész.**",
  ...
  "setup.fixHint": "A hiányzók javításához: a szerverbeállításokban nyisd meg a Vozi szerepét (vagy a csatorna jogosultságait), és engedélyezd a ❌ jellel jelölt elemeket.",
  ...
  "invite.noClientId": "A Vozi meghívólinkje még nincs beállítva (hiányzik a CLIENT_ID). Szólj a bot adminjának.",
  "invite.link": "Add hozzá a Vozit a szerveredhez:\n{url}",
  "vote.noClientId": "A Vozi szavazólinkje még nincs beállítva (hiányzik a CLIENT_ID). Szólj a bot adminjának.",
  "vote.link": "Szavazz a Vozira (ingyenes, 12 óránként), és segíts, hogy többen megtalálják:\n{url}",
  "help.title": "Vozi — írd be, hallgasd meg.",
  "help.embedTitle": "Vozi — Parancsok",
  "help.intro": "A Vozi hangosan felolvassa a szövegedet a hangcsatornákban — ingyenes neurális hangok, több tucat nyelven.",
  ...
  "welcome.footer": "Vozi — írd be, hallgasd meg.",
