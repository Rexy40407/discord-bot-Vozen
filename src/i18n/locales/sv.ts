export default {
  ...
  "preview.sample": "Hej, jag är Voxem. skriv det, hör det.",
  ...
  "setup.done": "**Allt klart — Voxem är redo.**",
  ...
  "setup.fixHint": "För att åtgärda det som saknas: öppna Voxems roll (eller kanalens behörigheter) i dina serverinställningar och aktivera de punkter som är markerade med ❌.",
  ...
  "invite.noClientId": "Voxems inbjudningslänk är inte uppsatt ännu (CLIENT_ID saknas). Meddela bottens administratör.",
  "invite.link": "Lägg till Voxem på din server:\n{url}",
  "vote.noClientId": "Voxems röstlänk är inte uppsatt ännu (CLIENT_ID saknas). Meddela bottens administratör.",
  "vote.link": "Rösta på Voxem (gratis, var 12:e timme) och hjälp fler att hitta den:\n{url}",
  "help.title": "Voxem — skriv det, hör det.",
  "help.embedTitle": "Voxem — Kommandon",
  "help.intro": "Voxem läser upp din text i röstkanaler — gratis neurala röster, dussintals språk.",
  ...
  "welcome.footer": "Voxem — skriv det, hör det.",
