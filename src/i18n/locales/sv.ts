export default {
  ...
  "preview.sample": "Hej, jag är Vozi. skriv det, hör det.",
  ...
  "setup.done": "**Allt klart — Vozi är redo.**",
  ...
  "setup.fixHint": "För att åtgärda det som saknas: öppna Vozis roll (eller kanalens behörigheter) i dina serverinställningar och aktivera de punkter som är markerade med ❌.",
  ...
  "invite.noClientId": "Vozis inbjudningslänk är inte uppsatt ännu (CLIENT_ID saknas). Meddela bottens administratör.",
  "invite.link": "Lägg till Vozi på din server:\n{url}",
  "vote.noClientId": "Vozis röstlänk är inte uppsatt ännu (CLIENT_ID saknas). Meddela bottens administratör.",
  "vote.link": "Rösta på Vozi (gratis, var 12:e timme) och hjälp fler att hitta den:\n{url}",
  "help.title": "Vozi — skriv det, hör det.",
  "help.embedTitle": "Vozi — Kommandon",
  "help.intro": "Vozi läser upp din text i röstkanaler — gratis neurala röster, dussintals språk.",
  ...
  "welcome.footer": "Vozi — skriv det, hör det.",
