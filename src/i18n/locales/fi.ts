export default {
  ...
  "preview.sample": "Hei, olen Voxem. kirjoita se, kuule se.",
  ...
  "setup.done": "**Kaikki valmista — Voxem on käyttövalmis.**",
  ...
  "setup.fixHint": "Korjataksesi puuttuvat: avaa palvelinasetuksissasi Voxemn rooli (tai kanavan oikeudet) ja ota käyttöön kohdat, jotka on merkitty ❌.",
  ...
  "invite.noClientId": "Voxemn kutsulinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "invite.link": "Lisää Voxem palvelimellesi:\n{url}",
  "vote.noClientId": "Voxemn äänestyslinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "vote.link": "Äänestä Voxema (ilmaista, 12 tunnin välein) ja auta useampia löytämään se:\n{url}",
  "help.title": "Voxem — kirjoita se, kuule se.",
  "help.embedTitle": "Voxem — Komennot",
  "help.intro": "Voxem lukee tekstisi ääneen puhekanavilla — ilmaisia neuroääniä, kymmeniä kieliä.",
  ...
  "help.groupMoreBody": "• /invite — lisää Voxem toiselle palvelimelle\n• /vote — äänestä Voxema top.gg-sivustolla\n• /help — näytä tämä ohje",
  "help.footer": "Uusi täällä? Suorita {command} päästäksesi alkuun.",
  "welcome.title": "Kiitos että lisäsit Voxemn! 👋",
  "welcome.description": "Voxem lukee chattisi ääneen puhekanavilla — kirjoita se, kuule se.\n\n**Pääset alkuun yhdessä vaiheessa:** suorita {setup} niin määritän automaattisen lukemisen ja liityn puhekanavallesi.\n\nTarvitsetko täyden komentolistan? Suorita {help}.",
  ...
  "welcome.footer": "Voxem — kirjoita se, kuule se.",
