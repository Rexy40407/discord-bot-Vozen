export default {
  ...
  "preview.sample": "Hei, olen Vozi. kirjoita se, kuule se.",
  ...
  "setup.done": "**Kaikki valmista — Vozi on käyttövalmis.**",
  ...
  "setup.fixHint": "Korjataksesi puuttuvat: avaa palvelinasetuksissasi Vozin rooli (tai kanavan oikeudet) ja ota käyttöön kohdat, jotka on merkitty ❌.",
  ...
  "invite.noClientId": "Vozin kutsulinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "invite.link": "Lisää Vozi palvelimellesi:\n{url}",
  "vote.noClientId": "Vozin äänestyslinkkiä ei ole vielä määritetty (CLIENT_ID puuttuu). Kerro botin ylläpitäjälle.",
  "vote.link": "Äänestä Vozia (ilmaista, 12 tunnin välein) ja auta useampia löytämään se:\n{url}",
  "help.title": "Vozi — kirjoita se, kuule se.",
  "help.embedTitle": "Vozi — Komennot",
  "help.intro": "Vozi lukee tekstisi ääneen puhekanavilla — ilmaisia neuroääniä, kymmeniä kieliä.",
  ...
  "welcome.footer": "Vozi — kirjoita se, kuule se.",
