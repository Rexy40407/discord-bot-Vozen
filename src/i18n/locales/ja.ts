...
export default {
  ...
  'privacy.eraseConfirm':
    '⚠️ これはすべてのサーバーにわたるあなたの Vozen データ**すべて**を完全に削除します：声の設定、読み上げ用ニックネーム、個人の略語と発音、保存した誕生日、ゲームのスコア、会話統計、オプトアウト、そしてすべての声のクローン（他人が作成したあなたの声の録音を含む）。**これは元に戻せません。** よろしいですか？',
  ...
  'premium.getHint':
    '今お使いのものはすべて無料のままです。Premium では8種類すべてのボイスエフェクト、声のクローン、24時間通話常駐、個人発音50件、/rizz、そしてプレミアムゲームが追加されます。支援：https://ko-fi.com/',
  'premium.linePass':
    '🎟️ **あなたの Premium パス：** ライセンス {used}/{total} 使用中 · {date} に期限切れ',
  'premium.passServers': '↳ 使用中：{servers}',
  'premium.pitch':
    'まだ Premium をお持ちではありません。**Vozen Premium**（3サーバーで €3.99/月、8サーバーで €7.99/月）は、サーバー全体に対して次を解除します：8種類すべてのボイスエフェクト、声のクローン、24時間通話常駐、個人発音50件（無料は3件）、/rizz コマンド、そしてプレミアムゲーム（Word Chain、Wordle、Chess）。**Vozen Plus**（€1.99/月）は、これらの特典をあなた個人にどのサーバーでも付与します。',
  'premium.buyHint':
