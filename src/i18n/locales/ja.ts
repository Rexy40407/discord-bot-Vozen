...
export default {
  ...
  "preview.sample": "こんにちは、Voxem です。入力して、聞いてみて。",
  ...
  "setup.done": "**準備完了：Voxem の用意ができました。**",
  ...
  "setup.fixHint": "不足しているものを直すには：サーバー設定で Voxem のロール（またはチャンネルの権限）を開き、❌ が付いた項目を有効にしてください。",
  ...
  "invite.noClientId": "Voxem の招待リンクはまだ設定されていません（CLIENT_ID がありません）。ボットの管理者にお知らせください。",
  "invite.link": "Voxem をあなたのサーバーに追加：\n{url}",
  "vote.noClientId": "Voxem の投票リンクはまだ設定されていません（CLIENT_ID がありません）。ボットの管理者にお知らせください。",
  "vote.link": "Voxem に投票して（無料・12時間ごと）、もっと多くの人に見つけてもらいましょう：\n{url}",
  "help.title": "Voxem — 入力して、聞く。",
  "help.embedTitle": "Voxem — コマンド",
  "help.intro": "Voxem はあなたのテキストをボイスチャンネルで読み上げます：無料のニューラル音声、何十もの言語。",
