...
export default {
  ...
  "preview.sample": "こんにちは、Vozi です。入力して、聞いてみて。",
  ...
  "setup.done": "**準備完了：Vozi の用意ができました。**",
  ...
  "setup.fixHint": "不足しているものを直すには：サーバー設定で Vozi のロール（またはチャンネルの権限）を開き、❌ が付いた項目を有効にしてください。",
  ...
  "invite.noClientId": "Vozi の招待リンクはまだ設定されていません（CLIENT_ID がありません）。ボットの管理者にお知らせください。",
  "invite.link": "Vozi をあなたのサーバーに追加：\n{url}",
  "vote.noClientId": "Vozi の投票リンクはまだ設定されていません（CLIENT_ID がありません）。ボットの管理者にお知らせください。",
  "vote.link": "Vozi に投票して（無料・12時間ごと）、もっと多くの人に見つけてもらいましょう：\n{url}",
  "help.title": "Vozi — 入力して、聞く。",
  "help.embedTitle": "Vozi — コマンド",
  "help.intro": "Vozi はあなたのテキストをボイスチャンネルで読み上げます：無料のニューラル音声、何十もの言語。",
