export default {
  ...
  "preview.sample": "Hola, soc en Vozi. Escriu-ho i escolta'l.",
  ...
  "setup.done": "**Tot a punt: en Vozi està preparat.**",
  ...
  "setup.fixHint": "Per arreglar el que falta: a la configuració del servidor, obre el rol d'en Vozi (o els permisos del canal) i activa els elements marcats amb ❌.",
  ...
  "stats.title": "**Estadístiques d'en Vozi**",
  ...
  "invite.noClientId": "L'enllaç d'invitació d'en Vozi encara no està configurat (falta CLIENT_ID). Avisa l'administrador del bot.",
  "invite.link": "Afegeix en Vozi al teu servidor:\n{url}",
  "vote.noClientId": "L'enllaç de vot d'en Vozi encara no està configurat (falta CLIENT_ID). Avisa l'administrador del bot.",
  "vote.link": "Vota en Vozi (gratis, cada 12 h) i ajuda que més gent el descobreixi:\n{url}",
  "help.title": "Vozi — escriu-ho i escolta'l.",
  "help.embedTitle": "Vozi — Ordres",
  "help.intro": "En Vozi llegeix el teu text en veu alta als canals de veu: veus neuronals gratuïtes i desenes de llengües.",
  ...
  "help.groupMore": "Més",
  "help.groupMoreBody": "• /invite — afegeix en Vozi a un altre servidor\n• /vote — vota en Vozi a top.gg\n• /help — mostra aquesta ajuda",
  "help.footer": "Ets nou aquí? Executa {command} per començar.",
  "welcome.title": "Gràcies per afegir en Vozi! 👋",
  "welcome.description": "En Vozi llegeix el teu xat en veu alta als canals de veu: escriu-ho i escolta'l.\n\n**Comença en un sol pas:** executa {setup} i configuraré la lectura automàtica i entraré al teu canal de veu.\n\nNecessites la llista completa d'ordres? Executa {help}.",
  ...
  "welcome.footer": "Vozi — escriu-ho i escolta'l.",
