export default {
  ...
  "preview.sample": "Hola, soc en Voxem. Escriu-ho i escolta'l.",
  ...
  "setup.done": "**Tot a punt: en Voxem està preparat.**",
  ...
  "setup.fixHint": "Per arreglar el que falta: a la configuració del servidor, obre el rol d'en Voxem (o els permisos del canal) i activa els elements marcats amb ❌.",
  ...
  "stats.title": "**Estadístiques d'en Voxem**",
  ...
  "invite.noClientId": "L'enllaç d'invitació d'en Voxem encara no està configurat (falta CLIENT_ID). Avisa l'administrador del bot.",
  "invite.link": "Afegeix en Voxem al teu servidor:\n{url}",
  "vote.noClientId": "L'enllaç de vot d'en Voxem encara no està configurat (falta CLIENT_ID). Avisa l'administrador del bot.",
  "vote.link": "Vota en Voxem (gratis, cada 12 h) i ajuda que més gent el descobreixi:\n{url}",
  "help.title": "Voxem — escriu-ho i escolta'l.",
  "help.embedTitle": "Voxem — Ordres",
  "help.intro": "En Voxem llegeix el teu text en veu alta als canals de veu: veus neuronals gratuïtes i desenes de llengües.",
  ...
  "help.groupMore": "Més",
  "help.groupMoreBody": "• /invite — afegeix en Voxem a un altre servidor\n• /vote — vota en Voxem a top.gg\n• /help — mostra aquesta ajuda",
  "help.footer": "Ets nou aquí? Executa {command} per començar.",
  "welcome.title": "Gràcies per afegir en Voxem! 👋",
  "welcome.description": "En Voxem llegeix el teu xat en veu alta als canals de veu: escriu-ho i escolta'l.\n\n**Comença en un sol pas:** executa {setup} i configuraré la lectura automàtica i entraré al teu canal de veu.\n\nNecessites la llista completa d'ordres? Executa {help}.",
  ...
  "welcome.footer": "Voxem — escriu-ho i escolta'l.",
