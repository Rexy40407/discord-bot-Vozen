export default {
  ...
  'privacy.eraseConfirm':
    '⚠️ Ово трајно брише **све** твоје Vozen податке на сваком серверу: подешавања гласа, изговорени надимак, личне скраћенице и изговоре, сачувани рођендан, резултате игара, статистику причања, искључивање, и сваки клон гласа (укључујући снимке твог гласа које су направили други). **Ово се не може опозвати.** Јеси ли сигуран?',
  ...
  'voice.optout': 'Више нећеш бити читан аутоматски. Покрени /voice optin да поново укључиш.',
  ...
  'clone.locked':
    '🔒 Клонирање гласа је Premium функција (кошта праву рачунарску снагу). Погледај `/premium`.',
  'clone.notInVoice':
    'Мораш бити у гласовном каналу **са мном** да би снимао. Прво користи `/join`.',
  'clone.alreadyRecording':
    'Већ снимаш узорак — заврши га (или притисни **⏹️ Заустави**) пре него што почнеш нови.',
  'clone.recording':
    '🎙️ **Снимам твој глас** — настави да причаш док се само не заустави (~{target}с говора, паузе се не рачунају), или притисни **⏹️ Заустави** кад год завршиш. Чувам само ТВОЈ звук.',
  'clone.recordingOther':
    '🎙️ **Снимам {who}** — треба да настави да прича док се само не заустави (~{target}с говора, паузе се не рачунају), или притисни **⏹️ Заустави** да заврши.',
  'clone.recordingProgress': '🔴 Снимам… **{got}с / {target}с** говора ухваћено. Настави!',
  'clone.consentRequest':
    '🎙️ {invoker} жели да сними **твој глас** ({target}с говора) да направи клон гласа којим може да прича. Дозвољаваш? *(истиче за 60с)*',
  'clone.consentAllow': 'Дозволи',
  'clone.consentDeny': 'Не',
  'clone.consentNotYou': 'Само особа која се снима може да одговори на ово.',
  'clone.consentGranted': '✅ {who} је пристао — почињем снимање.',
  'clone.consentRefused': '✖️ {who} је одбио. Снимање отказано — ниједан звук није ухваћен.',
  'clone.consentTimeout': '⌛ {who} није одговорио на време. Снимање отказано.',
  'clone.consentWaiting': '⏳ Чекам да {who} прихвати у каналу…',
  'clone.targetNotInVoice':
    '{who} мора бити у гласовном каналу **са мном** да би био снимљен. Замоли га да прво користи `/join`.',
  'clone.pickFromList':
    'Изабери особу са листе предлога (само они у позиву могу бити снимани). Остави празно да снимиш себе.',
  'clone.stopBtn': 'Заустави',
  'clone.stopNotYours': 'Само особа која снима може да заустави.',
  'clone.tooShort':
    'Ухватио сам само {seconds}с говора — треба ми бар ~{min}с (циљ је био {target}с) да добро клонирам. Покушај поново са `/voice clone record`.',
  'clone.saved':
    '✅ Узорак гласа сачуван ({seconds}с говора). Укључи га помоћу `/voice clone use active:true`. Само ТИ можеш користити свој клон; обриши га кад год желиш помоћу `/voice clone delete`.',
  'clone.savedOther':
    '✅ Сачувано {seconds}с гласа особе {who} као ТВОЈ клон. Укључи помоћу `/voice clone use active:true`; обриши кад год желиш помоћу `/voice clone delete`.',
  'clone.failed':
    'Снимање није успело — покушај поново. Ако се настави, поново уђи у гласовни канал.',
  'clone.none': 'Још немаш клон гласа. Сними један помоћу `/voice clone record` (Premium).',
  'clone.deleted': '🗑️ Клон гласа обрисан — узорак и запис о пристанку уклоњени, без трага.',
  'clone.revoked':
    '🛑 Пристанак повучен — уклонио сам {count} клон(ова) гласа које су други направили од твог гласа.',
  'clone.status': '🧬 Клон гласа: узорак снимљен {date} · тренутно **{state}**.',
  'clone.stateOn': 'УКЉУЧЕН',
  'clone.stateOff': 'искључен',
  'clone.noSample': 'Прво ти треба узорак — сними један помоћу `/voice clone record`.',
  'clone.enabled':
    '✅ Твоје поруке ће сада бити читане **твојим клонираним гласом**. Искључи кад год желиш помоћу `/voice clone use active:false`.',
  'clone.enabledNoEngine':
    '✅ Сачувано — али мотор за клонирање још није инсталиран на овој инстанци, па ћеш за сада чути нормалан глас.',
  'clone.disabled': '✅ Клонирани глас искључен — назад на твој нормалан глас.',
  'voice.effect.locked':
  ...
  'premium.getHint':
    'Све што данас користиш остаје бесплатно. Premium додаје свих 8 гласовних ефеката, клонирање гласа, 24/7 у позиву, 50 личних изговора, /rizz и premium игре. Подршка: https://ko-fi.com/',
  'premium.linePass': '🎟️ **Твој Premium пас:** {used}/{total} лиценци у употреби · истиче {date}',
  'premium.passServers': '↳ У употреби на: {servers}',
  'premium.pitch':
    'Још немаш Premium. **Vozen Premium** (€3.99/мес за 3 сервера, или €7.99/мес за 8) откључава за цео сервер: свих 8 гласовних ефеката, клонирање гласа, 24/7 у позиву, 50 личних изговора (уместо 3), команду /rizz и premium игре (Ланац речи, Wordle, Шах). **Vozen Plus** (€1.99/мес) даје ти те погодности лично, на било ком серверу.',
  'premium.buyHint':
  ...
  'config.channelSet':
    'Канал за аутоматско читање постављен на {channel}. Следеће: провери да ли је аутоматско читање укључено помоћу `/config autoread active:true`.',
  ...
  'config.xsaidOn':
    'Vozen ће сада најавити **ко је говорио** пре сваке поруке (нпр. „Alex је рекао ћао“). Искључи помоћу `/config xsaid active:false`.',
  ...
  'spron.listEmpty': 'Још ниједан — додај један помоћу `/serverpronunciation add`.',
  ...
  'spron.limitHit':
    '🔒 Сервер је достигао свој лимит од **{limit}** изговора. Уклони један помоћу `/serverpronunciation remove`.',
  ...
  'stt.busyClone':
    '⏳ Неко управо снима гласовни клон у овом позиву. Имам само један микрофон — покушај поново када заврши (неколико секунди).',
  'clone.busyStt':
    '⏳ У овом позиву ради транскрипција, а ја имам само један микрофон. Прво покрени `/transcribe stop`, па онда сними свој клон.',
};
