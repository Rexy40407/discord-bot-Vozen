/* Vozen site — i18n dictionary (EN base + PT). Toggle via .lang-toggle; English is
...
window.VOZEN_I18N = {
  en: {
    ...
    "hear.sub": "Every clip is generated by Vozen itself. Switch engines to compare Google, Piper and Kokoro.",
    ...
    "feat.1.d": "Pick a channel and Vozen reads every message out loud. Set it up once with /setup.",
    ...
    "feat.5.d": "Greets people who join — without repeating itself — wishes happy birthday, tells jokes, answers the magic 8-ball, and tracks your server's top speakers.",
    "feat.6.t": "Admin peace of mind",
    "feat.6.d": "Blocklists, rate limits, an anti-spam filter that mutes flooded messages, role gating, opt-out and a kill-switch. You stay in control.",
    ...
    "lang.sub": "Vozen hears the language of each message and answers in a native voice. Portuguese, English, Japanese, Arabic — even mixed in the same sentence. Everyone sets their own voice, with the names shown in their own language.",
    ...
    "setup.1.t": "Invite",
    "setup.1.d": "Add Vozen to your server with one click.",
    "setup.2.t": "/join",
    "setup.2.d": "Vozen hops into your voice channel.",
    "setup.3.t": "Type",
    ...
    "price.sub": "Everything Vozen does today stays free — forever. Premium adds the extras that cost us real compute.",
    ...
    "price.plus.name": "Vozen Plus",
    "price.plus.per": "/ month · per user",
    "price.plus.1": "All 8 voice effects — just for you",
    "price.plus.2": "Clone your own voice with /voice clone",
    "price.plus.3": "Your perks follow you to every server",
    "price.plus.4": "Priority synthesis queue",
    "price.plus.note": "€19.90/year (2 months free) · redeem with /redeem",
    "price.pro.badge": "PREMIUM",
    "price.pro.name": "Vozen Premium",
    "price.pro.per": "/ month · 2 servers",
    "price.pro.deal": "🎁 Pay for 1, get 2 — one subscription covers 2 servers",
    "price.pro.1": "All 8 voice effects (deep, demon, radio…)",
    "price.pro.2": "Voice cloning for the whole server",
  ...
  pt: {
    ...
    "hear.sub": "Cada clipe é gerado pelo próprio Vozen. Troca de motor para comparar o Google, o Piper e o Kokoro.",
    ...
    "feat.1.d": "Escolhe um canal e o Vozen lê cada mensagem em voz alta. Configura uma vez com /setup.",
    ...
    "feat.5.d": "Cumprimenta quem entra — sem se repetir — dá os parabéns no teu dia, conta piadas, responde à bola 8 e mostra os tagarelas do servidor.",
    "feat.6.t": "Descanso para os admins",
    "feat.6.d": "Blocklists, limites de taxa, filtro anti-spam que silencia mensagens spamadas, restrição por role, opt-out e kill-switch. O controlo é teu.",
    ...
    "lang.sub": "O Vozen ouve a língua de cada mensagem e responde numa voz nativa. Português, inglês, japonês, árabe — até misturados na mesma frase. Cada um define a sua voz, com os nomes na sua própria língua.",
    ...
    "setup.1.t": "Convidar",
    "setup.1.d": "Adiciona o Vozen ao teu servidor com um clique.",
    "setup.2.t": "/join",
    "setup.2.d": "O Vozen entra no teu canal de voz.",
    "setup.3.t": "Escrever",
    ...
    "price.sub": "Tudo o que o Vozen faz hoje continua grátis — para sempre. O Premium acrescenta os extras que nos custam computação a sério.",
    "price.free.name": "Free",
    "price.free.price": "€0",
    ...
    "price.plus.name": "Vozen Plus",
    "price.plus.per": "/ mês · por utilizador",
    "price.plus.1": "Os 8 efeitos de voz — só para ti",
    "price.plus.2": "Clona a tua própria voz com /voice clone",
    "price.plus.3": "As tuas vantagens seguem-te em todos os servidores",
    "price.plus.4": "Fila de síntese prioritária",
    "price.plus.note": "€19,90/ano (2 meses grátis) · resgata com /redeem",
    "price.pro.badge": "PREMIUM",
    "price.pro.name": "Vozen Premium",
    "price.pro.per": "/ mês · 2 servidores",
    "price.pro.deal": "🎁 Paga 1, leva 2 — uma subscrição cobre 2 servidores",
    "price.pro.1": "Os 8 efeitos de voz (grave, demónio, rádio…)",
    "price.pro.2": "Clone de voz para todo o servidor",
...
window.VOZEN_COMMANDS = {
  general: [
    ["/help", { en: "Show Vozen's command list", pt: "Mostra a lista de comandos" }],
    ...
    ["/shutup", { en: "Silence Vozen now (clears the queue)", pt: "Cala o Vozen já (esvazia a fila)" }],
    ["/setup", { en: "Guided one-step setup", pt: "Configuração guiada num passo" }],
    ["/invite", { en: "Get the invite link", pt: "Obtém o link de convite" }],
    ["/vote", { en: "Vote for Vozen on top.gg", pt: "Vota no Vozen no top.gg" }],
    ["/uptime", { en: "How long Vozen's been online", pt: "Há quanto tempo o Vozen está online" }],
  ...
  voice: [
    ["/voice set", { en: "Pick your voice, language & engine", pt: "Escolhe a tua voz, língua e motor" }],
    ["/voice list", { en: "Browse all voices", pt: "Vê todas as vozes" }],
    ["/voice preview", { en: "Hear a voice sample", pt: "Ouve uma amostra de voz" }],
    ["/voice clone", { en: "Clone your own voice (Premium)", pt: "Clona a tua própria voz (Premium)" }],
    ...
    ["/voice nickname", { en: "How Vozen calls you out loud", pt: "Como o Vozen te chama em voz alta" }],
  ...
  fun: [
    ...
    ["/laugh", { en: "Vozen laughs in your voice", pt: "O Vozen ri na tua voz" }],
    ...
    ["/birthday set", { en: "Vozen sings on your birthday", pt: "O Vozen dá-te os parabéns no teu dia" }],
...
window.VOZEN_FAQ = [
  ...
  [
    ...
    { en: "Yes. Each member sets their own voice and language with /voice set, and Vozen can even detect the language of each message automatically.", pt: "Sim. Cada membro define a sua voz e língua com /voice set, e o Vozen pode até detetar a língua de cada mensagem automaticamente." },
  ],
  [
    { en: "Google or Piper — which voice engine?", pt: "Google ou Piper — que motor de voz?" },
    { en: "Both are free. Google (the default) covers all 35 languages instantly; Piper runs on our own server and often sounds better in some languages, like Portuguese. Switch anytime with /voice set or /voice detection — it's per-person.", pt: "Os dois são grátis. O Google (padrão) cobre as 35 línguas na hora; o Piper corre no nosso servidor e costuma soar melhor nalgumas línguas, como o português. Troca quando quiseres com /voice set ou /voice detection — é por pessoa." },
  ],
  [
    { en: "How do I turn features off?", pt: "Como desligo funcionalidades?" },
    { en: "Everything is toggleable via /config — the greeting, auto-read, who-said announcements, the anti-spam filter, and more. There's also a full kill-switch.", pt: "Tudo é desligável com /config — a saudação, a leitura automática, os anúncios de quem falou, o filtro anti-spam, e mais. Há também um kill-switch completo." },
  ],
];
