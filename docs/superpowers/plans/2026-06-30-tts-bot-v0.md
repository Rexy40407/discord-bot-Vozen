...
const MODEL = process.env.PIPER_MODEL;      // ex: pt_PT-tugao-medium
...
```
npx tsc
$env:PIPER_PATH = "C:\piper\piper.exe"; $env:PIPER_MODELS = "C:\piper\models"; $env:PIPER_MODEL = "pt_PT-tugao-medium"; node scripts/manual-piper.mjs
```
